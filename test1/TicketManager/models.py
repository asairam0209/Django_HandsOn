...
class TicketManager(models.Model):
    ...
    clientId = models.ForeignKey(AuthUser, on_delete=models.CASCADE, related_name='tickets')
    role = models.ForeignKey(RoleModel, on_delete=models.CASCADE, related_name='tickets')
